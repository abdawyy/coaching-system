    ...
    <main>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="hero-cap hero-cap2 pt-70">
                                <h2 data-key="hero-contact-me">Contact me</h2>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="contact-section">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <h2 class="contact-title" data-key="get_in_touch">Get in Touch</h2>
                    </div>

                    <!-- Contact Form -->
                    <div class="col-lg-8">
                       <form class="form-contact contact_form" 
      action="{{ route('guest-messages.store') }}" 
      method="POST" 
      id="guestMessageForm" 
      novalidate>
    @csrf
                    ...
                    <div class="col-lg-3 offset-lg-1">
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3 data-key="address_title">Buttonwood, California.</h3>
                                <p data-key="address_text">Rosemead, CA 91770</p>
                            </div>
                        </div>
                        <div class="media contact-info">
                            <span class="contact-info__icon"><i class="ti-tablet"></i></span>
                            <div class="media-body">
                                <h3 data-key="phone_number">+1 253 565 2365</h3>
                                <p data-key="phone_time">Mon to Fri 9am to 6pm</p>
                            </div>
                        </div>
                        <div class="media contact-info">
                            <span class="contact-info__icon"><i class="ti-email"></i></span>
                            <div class="media-body">
                                <h3 data-key="email_address">support@colorlib.com</h3>
                                <p data-key="email_text">Send us your query anytime!</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-8">
                        <div class="single-services mb-40 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s">
                            ...
                            <div class="features-caption">
                                ...
                                <p data-key="service-desc1">You’ll look at graphs and charts in Task One, how to approach
                                </p>
                            </div>
                        </div>
                    </div>
